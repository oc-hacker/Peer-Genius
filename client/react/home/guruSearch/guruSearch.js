...
export class GuruSearch extends React.Component {
    render = () => {
        ...
        return (
            <div>
                <div>
                    <Text type='display2' color='white' className={classNames(classes.centerText, classes.headerText)}>Eliminate</Text>
                    <Text type='display1' color='black' className={classNames(classes.centerText, classes.headerText)}>The Grind</Text>
                </div>
