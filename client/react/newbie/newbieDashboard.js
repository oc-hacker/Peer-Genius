        ...
        return (
            <div style={{ display: 'block', width: '100%' }}>
                <div className={classNames(classes.headerText, classes.headerBackground)}>
                    <Text type='display1' color='white' className={classNames(classes.centerText, classes.headerText)}>YOUR DASHBOARD</Text>
                </div>
                ...
                <div className={classNames(classes.sidePadding)}>
                    ...
                    <div className={classNames(classes.inlineDiv, classes.paddingLeft)}>
                        ...
                        <Text type='subheading' color='rgb(1,147,172)' className={classNames(classes.inlineDiv, classes.textPadding, classes.centerText)} style={{marginLeft: 30}}><div className={classes.roundedDot} /><br />25 Hours</Text>
                        <Text type='subheading' color='rgb(1,147,172)' className={classNames(classes.inlineDiv, classes.textPadding, classes.centerText)} style={{marginLeft: 90}}><div className={classes.roundedDot} /><br />Bronze<br />100 Hours</Text>
                        <Text type='subheading' color='rgb(1,147,172)' className={classNames(classes.inlineDiv, classes.textPadding, classes.centerText)} style={{marginLeft: 90}}><div className={classes.roundedDot} /><br />Silver<br />175 Hours</Text>
                        <Text type='subheading' color='rgb(1,147,172)' className={classNames(classes.inlineDiv, classes.textPadding, classes.centerText)} style={{marginLeft: 90}}><div className={classes.roundedDot} /><br />Gold<br />250 Hours</Text>
                        <Button
                        flat color="primary"
