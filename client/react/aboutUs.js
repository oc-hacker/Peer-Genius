        ...
        return (
            <div>
                ...
                <div className={classes.backgroundHeader}>
                    <Text type='display2' color='white' className={classNames(classes.centerText, classes.topHeaderText)}>ABOUT US</Text>
                </div>
                <div>
                    <div>
                    ...
                    <div className={classNames(classes.centerDiv, classes.middleTiles)}>
                        <div className={classNames(classes.greyBackground, classes.roundedCorners, classes.middleTile)}>
                            ...
                            <Text type='subheading' color='black' className={classNames(classes.centerText, classes.bottomPadding)}>Dragon Kim Foundation</Text>
                        </div>
                        <div className={classNames(classes.greyBackground, classes.roundedCorners, classes.middleTile)}>
                            <p className={classNames(classes.centerText, classes.sidePadding)} ><img src='assets/ms_icon.png'/></p>
                            <Text type='subheading' color='black' className={classNames(classes.centerText, classes.bottomPadding)}>Month Service</Text>
                        </div>
                        ...
                        <div className={classNames(classes.blueBackground, classes.roundedCorners, classes.middleTile)}>
                            <p className={classNames(classes.centerText, classes.sidePadding)} ><img src='assets/businessguy_icon.png'/></p>
                            <Text type='subheading' color='white' className={classNames(classes.centerText, classes.bottomPadding)}>Month Service</Text>
                        </div>
                    </div>
                    <div>
